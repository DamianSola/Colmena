...
const More = () => {
    return(
        <div className="border border-greendark bg-transparent block sm:flex py-8 px-4 font text-greendark">
            <span className="bg-green w-4/5 sm:w-1/3 my-8 sm:m-4 p-4 sm:shadow-md">
