        ...
        <div className={`bg-white pt-12 px-8 lg:px-24 `}>
            ...
            <div className="py-8 items-center block md:flex">
                <aside className={`md:w-2/4 m-auto `} >
                    <img src={foto.src} height="500" width="500" alt='weDo' className="m-auto relative top-4" data-aos="fade-right"/>
                </aside>
                <p className={`lead text-justify lg:text-left md:text-xl text-l font-medium leading-relaxed md:px-8 py-8 md:w-2/4`} data-aos="fade-left">{weDo}</p>
            </div>
