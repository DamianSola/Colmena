...
const Contact = () => {
    return(
        <form className="flex-col mx-8 md:m-8 p-4 bg-transparent rounded md:w-2/5 md:mx-20">
            <label className="text-2xl md:text-lg font-meduim ">Nombre</label>
            <input className="w-full my-1 md:my-0 bg-green border-2 border-black" type="text" name="name"/><br/>  
            ...
            <input className="w-full my-1 md:my-0 bg-green border-2 border-black" type="email" name="mail"/><br/>
            <label className="text-2xl md:text-lg font-medium">Mensaje</label><br/>
            <textarea className="w-full my-3 md:my-0 bg-green border-2 border-black" name="message" rows="4"></textarea><br/>
