        ...
        <div className="bg-white" id="about">
            <div  className={`hidden md:block pt-20 w-full mx-auto px-4 sm:px-6 lg:px-24 `}  >
                ...
                <div className="flex gap-8 items-center" >
                        <p className={`lead text-left text-xl text-justify font-medium leading-relaxed w-2/4`} data-aos="fade-up">
                            {description}
                        </p>
                    <aside className="hidden md:flex justify-right items-center w-1/2 h-auto">
                        <img src={foto.src} alt="descripcion" className="w-full" data-aos="fade-up"/>
                    </aside>
                </div>
            </div>
            <div className={`md:hidden flex-col bg-white w-auto pt-4 `}>
                ...
                <aside className="flex justify-center w-full items-center px-8">
                    <img src={foto.src} className="w-full" alt="descrripcion" data-aos="fade-up"/>
                </aside>
