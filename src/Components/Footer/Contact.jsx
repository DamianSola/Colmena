...
const Contact = () => {
    return(
        <form className="flex-col mx-8 md:m-8 p-4 bg-transparent rounded md:w-2/5 md:mx-20">
            ...
            <input className="w-full my-1 md:my-1 bg-green border-2 border-black" type="text" name="name"/><br/>  
            ...
            <input className="w-full my-1 md:my-1 bg-green border-2 border-black" type="email" name="mail"/><br/>
